...
@section('banner')
    <x-banner backgroundImage="{{ asset('assets/2nd-banner.jpg') }}">
        <h1 class="text-white fw-bold">Travel More <span class="text-danger">&mdash;</span> Visa Worries Less</h1>
        <p class="hero-text text-light">Smooth visa processing for your dream destinations</p>
    </x-banner>
@endsection
...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="card shadow-sm mb-4 p-3">
            <p>We specialize in tourist visa processing, ensuring your documents are complete and applications submitted
                accurately.</p>
        </div>
